...
public class SearchCard extends AppCompatActivity {
    ...
    public void searchCard (View view){
        ...
        new FetchInfo(mNameText, mCardImage, mCardLevel, mCardRace, mCardAttribute, mCardType, mDescText, mCardAttackAndDef, mCardArchetype, mCardPrice,mClassName).execute(queryString);
        mReturnSearchButton.setVisibility(View.VISIBLE);
    }
